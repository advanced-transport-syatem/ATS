...
$sel="SELECT * FROM `bus` where Origin='gandhinagar' and Destination='bhuj'  and Date >= CURDATE() + INTERVAL 31 DAY" ;
...
else
{
	...
	echo '<h3 style= "text-align:center;"> <font color="red"><center>Available Buses From Gandhinagar To Bhuj </center></font></h3>';
